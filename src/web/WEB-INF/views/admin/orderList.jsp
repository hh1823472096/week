            ...
            <table class="table table-condensed">
                ...
                <c:forEach var="o" items="${orderList}">
                    <tr>
                        ...
                        <td>${o.orderDate}</td>
                        <%
                            com.huanghong.model.Order o=(com.huanghong.model.Order)pageContext.findAttribute("o");
                            int userId=o.getCustomerId();
                            java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
                            com.huanghong.dao.UserDao userDao=new com.huanghong.dao.UserDao();
                        ...
                        <td class="cart_total">
                            <%
                                ...
                                String paymentType=com.huanghong.model.Payment.findByPaymentId(con,n);
                            %>
